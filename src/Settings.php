...
final class Settings
{
    ...
    public const MAP = [
        ...
        'remediation_critical' => 'report.remediation.targets.critical',
        'remediation_serious' => 'report.remediation.targets.serious',
        'remediation_moderate' => 'report.remediation.targets.moderate',
        'remediation_minor' => 'report.remediation.targets.minor',
        'remediation_exception_days' => 'report.remediation.exception_days',
